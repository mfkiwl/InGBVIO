...
namespace ingvio
{
    ...
    void IngvioParams::readParams(const std::string& config_path)
    {
        ...
        fs["gps_fix_topic"] >> _gps_fix_topic;
        fs["baro_topic"] >> _baro_topic;
        ...
        _max_baro_buffer_size = fs["max_baro_buffer_size"];
    ...
    void IngvioParams::printParams()
    {
        ...
        std::cout << "gps_fix_topic: " << _gps_fix_topic << std::endl;

        std::cout << "baro_topic: " << _baro_topic << std::endl;
