...
namespace ingvio
{
    ...
    public:
        ...
        BaroCtrl(const irp_sen_msgs::altimeter::ConstPtr& baro_msg)
        {
            _pressure = baro_msg->data;
    ...
    public:
        ...
        void storeBaro(const  irp_sen_msgs::altimeter::ConstPtr& baro_msg)
        {
        ...
        std::cout << "[BaroMeas]: store baro ctrl!" << std::endl;
